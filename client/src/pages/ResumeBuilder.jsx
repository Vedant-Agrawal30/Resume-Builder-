          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-4 relative">
              ...
              <div className="relative w-full h-1 mb-4">
                ...
                <div
                  className="absolute top-0 left-0 h-1 bg-linear-to-r from-green-500 to-green-600 rounded-full transition-all duration-700 ease-in-out"
                  style={{
          ...
          <div className="lg:col-span-7 max-lg:mt-6">
            <div className='relative w-full'>
              <div className='absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2'>
                ...
                <button onClick={changeResumeVisibility} className="flex items-center p-2 px-4 gap-2 text-xs bg-linear-to-br from-purple-100 to-purple-200 text-purple-600 ring-purple-300 rounded-lg hovering transition-colors">
...
// import { dummyResumeData } from '../assets/assets/assets';
// import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, FileText, FolderIcon, GraduationCap, icons, Sparkles, User } from 'lucide-react';
// import PersonalInfoFrom from '../components/PersonalInfoFrom';
// import ResumePreview from '../components/ResumePreview';
// import TemplateSelector from '../components/TemplateSelector';
// import ColorPicker from '../components/ColorPicker';
...
//               {/* Progress bar using activesction index */}
//               <hr className='absolute top-0 left-0 ring-0 border-2 border-gray-200' />
//               <hr className='absolute top-0 left-0 bg-linear-to-r from-green-500 to-green-600 border-none transition-all duration-2000' style={{ width: `${activeSectionIndex * 100 / (sections.length - 1)}%` }} />
