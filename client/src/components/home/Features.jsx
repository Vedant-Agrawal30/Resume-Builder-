...
const Features = () => {
 ...
 return (
    ...
    <Zap width={14}/>
        ...
        <Title title="Build your resume" description="Our streamlined process helps you create a professional resume in minuts with intelligent AI-powered tools and features."/>
